            ...
            <div className="flex justify-center space-x-8 flex-wrap gap-6">
              ...
              >
                <svg width="40" height="40" viewBox="0 0 24 24">
                  <defs>
                    <linearGradient id="instagramGradientHome" x1="0%" y1="0%" x2="100%" y2="100%">
                  ...
                  <path
                    fill="url(#instagramGradientHome)"
              ...
              >
                <svg width="40" height="40" viewBox="0 0 24 24" fill="none">
                  ...
                  <path
                    fill="#FE2C55"
                    d="M16.1 6.4c.8.6 1.8.9 2.8 1V9.6c-1.1 0-2.2-.3-3.2-.8v5.8c0 3-2.5 5.5-5.5 5.5-.9 0-1.8-.2-2.6-.5a5.49 5.49 0 0 0 8.5-4.8V6.4z"
                  />
                  <path
                    fill="#010101"
