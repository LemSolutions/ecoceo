...
import { marketingService, Campaign, Lead } from '@/services/_external/marketingService';
...
export default function MarketingView() {
  ...
  return (
    <div className="space-y-6 min-h-full p-6">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="block px-3 py-2 border border-gray-300 bg-white/30 backdrop-blur/30 backdrop-blur rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
              >
      ...
      <div className="bg-white/30 backdrop-blur/30 backdrop-blur/80 backdrop-blur-sm rounded-lg shadow-sm border border-gray-200/50">
                  ...
                  <div key={campaign.id} className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                    ...
                    <div className="flex space-x-2">
                      <button
                        ...
                        className="flex-1 inline-flex items-center justify-center px-3 py-2 border border-blue-300 shadow-sm text-xs font-medium rounded text-blue-700 bg-white/30 backdrop-blur/30 backdrop-blur hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                      >
                        ✏️ Modifica
                      </button>
                      <button
                        onClick={() => handleDeleteCampaign(campaign.id)}
                        className="flex-1 inline-flex items-center justify-center px-3 py-2 border border-red-300 shadow-sm text-xs font-medium rounded text-red-700 bg-white/30 backdrop-blur/30 backdrop-blur hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                      >
                        🗑️ Elimina
                      </button>
                    </div>
                  ...
                  <div key={lead.id} className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                    ...
                    <div className="flex space-x-1">
                      <button
                        ...
                        className="flex-1 inline-flex items-center justify-center px-2 py-1.5 border border-green-300 shadow-sm text-xs font-medium rounded text-green-700 bg-white/30 backdrop-blur/30 backdrop-blur hover:bg-green-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                      >
                        ✏️
                      </button>
                      <button
                        onClick={() => handleDeleteLead(lead.id)}
                        className="flex-1 inline-flex items-center justify-center px-2 py-1.5 border border-red-300 shadow-sm text-xs font-medium rounded text-red-700 bg-white/30 backdrop-blur/30 backdrop-blur hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                      >
                        🗑️
                      </button>
                    </div>
            ...
            <div className="relative bg-white/30 backdrop-blur/30 backdrop-blur rounded-lg p-6 max-w-lg w-full max-h-[90vh] overflow-y-auto shadow-xl">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm text-gray-900 bg-white/30 backdrop-blur/30 backdrop-blur"
              ...
              <div className="mt-6 sm:flex sm:flex-row-reverse">
                ...
                <button
                  ...
                  className="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white/30 backdrop-blur/30 backdrop-blur text-base font-medium text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:mt-0 sm:w-auto sm:text-sm"
                >
                  Annulla
                </button>
              </div>
            ...
            <div className="inline-block bg-white/30 backdrop-blur/30 backdrop-blur rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all max-w-lg w-full p-6 relative z-10">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm text-gray-900 bg-white/30 backdrop-blur/30 backdrop-blur"
                        placeholder="Nome"
                      />
                    </div>
              ...
              <div className="mt-6 sm:flex sm:flex-row-reverse">
                ...
                <button
                  ...
                  className="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white/30 backdrop-blur/30 backdrop-blur text-base font-medium text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 sm:mt-0 sm:w-auto sm:text-sm"
                >
                  Annulla
                </button>
              </div>
