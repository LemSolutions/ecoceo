        ...
        <div className="container">
          ...
          <div className="border-t border-gray-300/30 py-8 mt-8">
            <div className="text-center text-white">
              <h3 className="text-2xl font-bold mb-6 text-white !text-white tracking-wide uppercase">
                Seguici sui Social
              </h3>
            ...
            <div className="mt-4 pt-4 border-t border-gray-300/30">
              <div className="flex flex-wrap justify-center gap-6">
                <a 
                  ...
                  className="iubenda-black iubenda-noiframe iubenda-embed iubenda-noiframe text-white hover:text-orange-300 text-sm transition duration-300" 
