...
const Footer = () => {
  ...
  return (
    <>
      <footer className="relative z-10 text-white pt-4 md:pt-8" style={{
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
            ...
            <div className="mb-6 md:mb-12 lg:mb-16">
              <h3 className="!text-white mb-4 md:mb-8 text-sm md:text-xl font-semibold">
                Link Rapidi
              </h3>
              <ul className="space-y-2 md:space-y-3">
                <li>
                  <Link
                    href="/about"
                    className="text-white hover:text-orange-300 text-xs md:text-base font-medium transition duration-300"
                  >
                    Chi Siamo
                  </Link>
                </li>
            ...
            <div className="mb-6 md:mb-12 lg:mb-16">
              ...
              <div className="space-y-2 md:space-y-4">
                <div>
                  <p className="!text-white text-xs md:text-sm font-medium mb-0.5 md:mb-1">
                    Ragione sociale
                  </p>
              ...
              <div className="mt-4 md:mt-6 space-y-2 md:space-y-3">
                <div className="flex items-center">
                  <div className="bg-white/30 backdrop-blur/30 backdrop-blur/20 mr-2 md:mr-3 flex h-6 w-6 md:h-8 md:w-8 items-center justify-center overflow-hidden rounded-full">
                    <svg
                      width="10"
                      height="10"
                      viewBox="0 0 16 16"
                      className="fill-current text-white md:w-3.5 md:h-3.5"
                    >
                  ...
                  <div>
                    ...
                    <a 
                      ...
                      className="text-white hover:text-orange-300 text-xs md:text-sm transition duration-300"
                    >
          ...
          <div className="border-t border-gray-300/30 py-4 md:py-8 mt-4 md:mt-8">
            <div className="text-center text-white">
              <h3 className="text-sm md:text-2xl font-bold mb-3 md:mb-6 text-white !text-white tracking-wide uppercase">
                Seguici sui Social
              </h3>
              <div className="flex justify-center space-x-3 md:space-x-6">
                ...
                <a
                  ...
                  className="bg-white/20 backdrop-blur/30 hover:bg-white/30 flex h-10 w-10 md:h-16 md:w-16 items-center justify-center rounded-full text-white hover:text-orange-300 transition duration-300 ease-in-out transform hover:scale-110"
                ...
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" className="md:w-8 md:h-8">
                    <path
                      fill="white"
                ...
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="md:w-8 md:h-8">
                    <path
                      fill="white"
        ...
        {/* Mappa Google Maps */}
        <div className="border-t border-gray-300/30 py-3 md:py-6">
          <div className="container">
            <div className="mb-3 md:mb-6">
              <h3 className="!text-white text-sm md:text-lg font-semibold text-center mb-2 md:mb-4">
                La Nostra Sede
              </h3>
        ...
        <div className="border-t border-gray-300/50 py-4 md:py-8">
          <div className="container">
            ...
            {/* Legal Links - Iubenda */}
            <div className="mt-2 md:mt-4 pt-2 md:pt-4 border-t border-gray-300/30">
              <div className="flex flex-wrap justify-center gap-3 md:gap-6">
                <a 
                  href="https://www.iubenda.com/privacy-policy/43054480" 
                  className="iubenda-black iubenda-noiframe iubenda-embed iubenda-noiframe text-white hover:text-orange-300 text-xs md:text-sm transition duration-300" 
