...
const SubscriptionPlans = () => {
  ...
  return (
    <div className="py-16  from-white via-orange-100 to-orange-400">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {plans.map((plan) => (
            <div
              key={plan.id}
              className={`relative bg-white/30 backdrop-blur/30 backdrop-blurrounded-2xl shadow-lg overflow-hidden ${
        ...
        <div className="text-center mt-12">
          <div className="bg-white/30 backdrop-blur/30 backdrop-blurrounded-lg shadow-lg p-8 max-w-2xl mx-auto">
